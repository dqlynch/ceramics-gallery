...
export const products: Product[] = [
  ...
  },
  {
    id: 12,
    title: 'Ikebana Vase',
    mainImage: '/images/ikebana-vase/1.jpg',
    gallery: [
      '/images/ikebana-vase/1.jpg',
      '/images/ikebana-vase/2.jpg',
      '/images/ikebana-vase/3.jpg',
      '/images/ikebana-vase/4.jpg',
    ],
    videos: [
      '/images/ikebana-vase/5.mp4',
      '/images/ikebana-vase/6.mp4',
    ],
    dimensions: 'Approx. 10" x 12"',
    price: 'Commission',
    description: 'A large commissioned vase designed for ikebana. The wide flaring form gives plenty of room for arrangements. The vase is left unglazed and covered in a thin layer of raw black slip. Thin sgraffito trails were carved into the slip, revealing the off-white stoneware body underneath.',
    material: 'B-Mix and SPS Eclipse Slip',
    firing_type: '∆5',
    sold: true,
  },
  {
  ...
  },
  {
    ...
    dimensions: '3" x 3.5"',
    price: '$20',
    description: 'My first ever finished piece! A small vessel (no drainage) with a light purple, slightly crazed glaze. Comes with some Tradescantia Zebrina happily growing inside.\n\nFood, microwave, and dishwasher safe.\n\nPlant care: water when dry, as much light you can get it. Very easy plant and grows/roots extremely quickly.',
    material: 'Stoneware (SPS Sea Mix 6)',
    firing_type: '∆5',
    sold: true,
  }
